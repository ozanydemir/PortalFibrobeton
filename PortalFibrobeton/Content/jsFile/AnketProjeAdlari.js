$("body").on("click", "#btnAddProjeAd", function () {
    ...
    var rowCount = $('#tblProjeAd').find('tr').length;

    //Get the reference of the Table's TBODY element.
    var tBody = $("#tblProjeAd > TBODY")[0];
...
$("body").on("click", "#btnAddProjeAdSablon", function () {
    ...
    //Add SoruNo cell.
    var cell = $(row.insertCell(-1));
    cell.html($('#tblProjeAd').find('tr').length - 1);
...
$("body").on("click", "#btnSave", function () {
    ...
    var anket = new Array();
    $("#tblProjeAd TBODY TR").each(function () {
        var row = $(this);
        var proje = {};
