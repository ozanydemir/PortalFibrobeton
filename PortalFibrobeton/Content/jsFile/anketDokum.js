$("body").on("click", "#btnAddDokum", function () {
    //Reference the Name and Country TextBoxes.
    var txtNo = $("#txtNoDokum");
    var txtSoru = $("#txtSoruDokum");
    var txtK1 = $("#txtK1Dokum");
    var txtK2 = $("#txtK2Dokum");
    var txtK3 = $("#txtK3Dokum");
    var txtK4 = $("#txtK4Dokum");
    var txtK5 = $("#txtK5Dokum");
    var txtAsama = $("#txtAsamaDokum");
    var txtAnketAdi = $("#anketAdi");
    var DokumGenelValue = $("#dokumGenel").val();

    var rowCount = $('#tblDokum').find('tr').length;



    //Get the reference of the Table's TBODY element.
    var tBody = $("#tblDokum > TBODY")[0];
    ...
    cell = $(row.insertCell(-1));
    cell.html(DokumGenelValue);

    //Add Button cell.
    cell = $(row.insertCell(-1));
    var btnRemove = $("<input />");
    btnRemove.attr("type", "button");
    btnRemove.attr("onclick", "RemoveDokum(this);");
    btnRemove.val("Sil");
...
$("body").on("click", "#btnSave", function () {
    ...
    var anket = new Array();
    $("#tblDokum TBODY TR").each(function () {
        var row = $(this);
        var proje = {};
