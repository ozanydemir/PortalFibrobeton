$("body").on("click", "#btnAddKalip", function () {
    //Reference the Name and Country TextBoxes.
    var txtNo = $("#txtNoKalip");
    var txtSoru = $("#txtSoruKalip");
    var txtK1 = $("#txtK1Kalip");
    var txtK2 = $("#txtK2Kalip");
    var txtK3 = $("#txtK3Kalip");
    var txtK4 = $("#txtK4Kalip");
    var txtK5 = $("#txtK5Kalip");
    var txtAsama = $("#txtAsamaKalip");
    var txtAnketAdi = $("#anketAdi");
    var kalipGenelValue = $("#kalipGenel").val();

    var rowCount = $('#tblKalip').find('tr').length;



    //Get the reference of the Table's TBODY element.
    var tBody = $("#tblKalip > TBODY")[0];
    ...
    btnRemove.attr("onclick", "RemoveKalip(this);");
    btnRemove.val("Sil");
...
$("body").on("click", "#btnSave", function () {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            alert("Hata oluştu - Kalıp Aşaması: " + errorThrown);
        }
    });
});