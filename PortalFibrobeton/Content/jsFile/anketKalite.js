$("body").on("click", "#btnAddKalite", function () {
    //Reference the Name and Country TextBoxes.
    var txtNo = $("#txtNoKalite");
    var txtSoru = $("#txtSoruKalite");
    var txtK1 = $("#txtK1Kalite");
    var txtK2 = $("#txtK2Kalite");
    var txtK3 = $("#txtK3Kalite");
    var txtK4 = $("#txtK4Kalite");
    var txtK5 = $("#txtK5Kalite");
    var txtAsama = $("#txtAsamaKalite");
    var txtAnketAdi = $("#anketAdi");
    var kaliteGenelValue = $("#kaliteGenel").val();

    var rowCount = $('#tblKalite').find('tr').length;



    //Get the reference of the Table's TBODY element.
    var tBody = $("#tblKalite > TBODY")[0];
    ...
    cell = $(row.insertCell(-1));
    cell.html(kaliteGenelValue);

    //Add Button cell.
    cell = $(row.insertCell(-1));
    var btnRemove = $("<input />");
    btnRemove.attr("type", "button");
    btnRemove.attr("onclick", "RemoveKalite(this);");
    btnRemove.val("Sil");
...
$("body").on("click", "#btnSave", function () {
    ...
    var anket = new Array();
    $("#tblKalite TBODY TR").each(function () {
        var row = $(this);
        var proje = {};
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            alert("Hata oluştu - Kalite: " + errorThrown);
        }
    });
});