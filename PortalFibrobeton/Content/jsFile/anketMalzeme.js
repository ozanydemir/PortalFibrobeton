$("body").on("click", "#btnAddMalzeme", function () {
    //Reference the Name and Country TextBoxes.
    var txtNo = $("#txtNoMalzeme");
    var txtSoru = $("#txtSoruMalzeme");
    var txtK1 = $("#txtK1Malzeme");
    var txtK2 = $("#txtK2Malzeme");
    var txtK3 = $("#txtK3Malzeme");
    var txtK4 = $("#txtK4Malzeme");
    var txtK5 = $("#txtK5Malzeme");
    var txtAsama = $("#txtAsamaMalzeme");
    var txtAnketAdi = $("#anketAdi");
    var malzemeGenelValue = $("#malzemeGenel").val();

    var rowCount = $('#tblMalzeme').find('tr').length;



    //Get the reference of the Table's TBODY element.
    var tBody = $("#tblMalzeme > TBODY")[0];
    ...
    cell = $(row.insertCell(-1));
    cell.html(malzemeGenelValue);

    //Add Button cell.
    cell = $(row.insertCell(-1));
    var btnRemove = $("<input />");
    btnRemove.attr("type", "button");
    btnRemove.attr("onclick", "RemoveMalzeme(this);");
    btnRemove.val("Sil");
...
$("body").on("click", "#btnSave", function () {
    ...
    var anket = new Array();
    $("#tblMalzeme TBODY TR").each(function () {
        var row = $(this);
        var proje = {};
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            alert("Hata oluştu - Malzeme: " + errorThrown);
        }
    });
});