$("body").on("click", "#btnAddProje", function () {
...
$("body").on("click", "#btnSave", function () {
    ...
    $("#tblProje TBODY TR").each(function () {
        var row = $(this);
        var proje = {};
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            alert("Hata oluştu - Proje Aşaması: " + errorThrown);
        }
    });
});