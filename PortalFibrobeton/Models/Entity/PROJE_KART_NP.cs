...
namespace PortalFibrobeton.Models.Entity
{
    ...
    public partial class PROJE_KART_NP
    {
        ...
        public Nullable<double> PROJE_GUN { get; set; }
        public Nullable<double> PROJE_GERCEK_GUN { get; set; }
        public string PROJE_GERCEK_GUN_LIST { get; set; }
        public Nullable<double> PROJE_SATIS_M2 { get; set; }
        public Nullable<double> PROJE_SATIS_MIKTAR { get; set; }
        public string SANTIYE_SEFI { get; set; }
        public Nullable<double> SOZLESME_M2 { get; set; }
        public Nullable<double> SOZLESME_M2_KONTROL_YUZDESI { get; set; }
        public Nullable<double> WEB_PANEL_YANLIS_SIFRE { get; set; }
        ...
        public Nullable<double> MONTAJ_GUN { get; set; }
        public string MASTIK { get; set; }
        public string BOYA { get; set; }
        public Nullable<double> KUR_SURE_GUN { get; set; }
        ...
        public Nullable<System.DateTime> SIPARIS_BASLANMA_TARIH { get; set; }
        public Nullable<System.DateTime> SIPARIS_BITIS_TARIH { get; set; }
        public Nullable<double> SIPARIS_GUN { get; set; }
        public Nullable<System.DateTime> DOKUM_BASLANMA_TARIH { get; set; }
        public Nullable<System.DateTime> DOKUM_BITIS_TARIH { get; set; }
        public Nullable<double> DOKUM_GUN { get; set; }
        public Nullable<double> ONG_SOKUM_SURE_GUN { get; set; }
    }
}
